...
contract CreateOrder is Script {
    function run() external {
        ...
        uint256 expiryWindow = 86400 * 7; // 1 day * 7 = 7 days

        address expectedOutToken = 0x79A02482A880bCE3F13e09Da970dC34db4CD24d1; // USDC on Worldchain

        bytes32 hookExecutorSalt = bytes32(uint256(0x01a4)); // From API response
        ...
        bytes memory approveHookCallData =
            hex""; // From API
        ...
        bytes memory swapHookCallData =
            hex""; // From API
        ...
        // === Call just the create order function ===
        // escrow.createOrder(usrDstAddress, srcToken, srcAmount, dstToken, dstAmount, dstChainId, expiryWindow);
