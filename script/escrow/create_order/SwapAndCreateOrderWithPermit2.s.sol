...
contract SwapAndCreateOrderWithPermit2 is Script {
    ...
    function run() external {
        ...
        // Escrow + user
        address payable escrowAddr = payable(0x351fd704EA9507771808B4011E6a548aC0D5174a); // <-- YOUR ESCROW
        ...
        uint256 dstAmount = 1_000_0; // example: 0.010000 USDC (6dp)
        ...
        bytes32 hookExecutorSalt = bytes32(uint256(0x835691181b18588200fefcf618d868ccabc05fdd84f952d4026bd32746652625)); // MUST match API's assumption
        ...
        hooks[1] = HookExecutor.Hook({
            ...
            callData: hex""
        });
