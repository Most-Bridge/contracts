...
contract MockEscrow is Test {
    ...
    function getValuesFromSlots(
    ...
    ) public returns (bytes32 orderIdValue, bytes32 dstAddressValue, bytes32 mmSrcAddressValue, bytes32 amountValue) {
        ...
        return (orderIdValue, dstAddressValue, mmSrcAddressValue, amountValue);
    }
