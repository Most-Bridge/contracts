...
import {ModuleTask, ModuleCodecs} from "lib/satellite/solidity/src/libraries/internal/data-processor/ModuleCodecs.sol";
import {IDataProcessorModule} from "lib/satellite/solidity/src/interfaces/modules/IDataProcessorModule.sol";
...
contract Escrow is ReentrancyGuard, Pausable {
    ...
    // HDP
    address public HDP_EXECUTION_STORE_ADDRESS = 0x623e64Ca0a408641fF5E0158a3dFe109b51128F6;
